...
const builder = {
    ...
    already_loggedIn: (prefix) => builder.prepare(200, prefix, 'already loggedIn'),
    already_logout: (prefix) => builder.prepare(409, prefix, 'already logout'),
    ...
    notifications,
    unprocessable_entity: (prefix) => builder.prepare(422, prefix, ''),
    permission_denied: (prefix) =>
        builder.prepare(403, prefix, 'don\'t have permission'),
};
